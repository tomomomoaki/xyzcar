...
|  2 | 車種検索 | タグ、キーワードから閲覧したい車の情報を絞る | タグ、キーワードが含まれるレビューのみを表示する | ヘッダーに検索フォームがあり、タグ名やキーワードを入力すると、そのレビューだけをsearchに表示する。 | 7h |
|  2 | 絞り込み検索 | メーカー、ボディタイプ、車名から閲覧したい車の情報を絞る | 絞った条件に当てはまるレビューのみを表示する |　サイドバーにメーカー、ボディタイプ、車名を入力するフォームがあり、入力した条件のレビューのみを表示する。 | 7h |
